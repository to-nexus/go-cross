...
func Bind(types []string, abis []string, bytecodes, runtimebytecodes []string, fsigs []map[string]string, pkg string, libs map[string]string, aliases map[string]string) (string, error) {
	// ##CROSS: abigen
	...
	for i := 0; i < len(types); i++ {
		...
		contracts[types[i]] = &tmplContract{
			...
			InputBinRuntime: strings.TrimPrefix(strings.TrimSpace(binRuntime), "0x"),
