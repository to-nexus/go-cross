...
type tmplContract struct {
	...
	InputBinRuntime string                 // Optional EVM-Runtime bytecode used to add genesis block // ##CROSS: abigen
...
func newTmplContractV2(typ string, abiStr string, bytecode, runtimebytecode string, constructor abi.Method, cb *contractBinder) *tmplContractV2 {
	// ##CROSS: abigen
	// runtimebytecode is added
	...
	return &tmplContractV2{
		...
		strings.TrimPrefix(strings.TrimSpace(runtimebytecode), "0x"), // ##CROSS: abigen
		constructor,
		cb.calls,
		cb.events,
