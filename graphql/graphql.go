...
func (t *Transaction) GasPrice(ctx context.Context) hexutil.Big {
	...
	switch tx.Type() {
	case types.DynamicFeeTxType, types.FeeDelegatedDynamicFeeTxType: // ##CROSS: fee delegation
		if block != nil {
...
func (t *Transaction) MaxFeePerGas(ctx context.Context) *hexutil.Big {
	...
	switch tx.Type() {
	case types.DynamicFeeTxType, types.BlobTxType, types.FeeDelegatedDynamicFeeTxType, types.SetCodeTxType: // ##CROSS: fee delegation
