...
var (
	...
	MinBlocksForBlobRequests           uint64 = MinTimeDurationForBlobRequests
	DefaultExtraReserveForBlobRequests uint64 = uint64(24 * 3600) // it adds more time for expired blobs for some request cases, like expiry blob when remote peer is syncing, default 1 day.
)
