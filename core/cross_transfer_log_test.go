...
func TestCrossTransferSig(t *testing.T) {
	if contracts.CrossExAddr.String() != "0xfeed00000000000000000000000000000000C0DE" {
		t.Fatalf("CrossExAddr: got %s, want %s", contracts.CrossExAddr.String(), "0xfeed00000000000000000000000000000000C0DE")
	}
...
func TestAddTransferLog_transferTx(t *testing.T) {
	var (
		...
		gspecWithCrossEx = &Genesis{
			Config: testAdventureConfig,
			Alloc: types.GenesisAlloc{
				contracts.CrossExAddr: types.Account{
