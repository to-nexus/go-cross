...
type BlockContext struct {
	...
	PoSAActive bool // ##CROSS: istanbul posa
}
...
func NewEVM(blockCtx BlockContext, statedb StateDB, chainConfig *params.ChainConfig, config Config) *EVM {
	...
	case evm.chainRules.IsBreakpoint:
		evm.table = &breakpointInstructionSet
	// ##
	...
	case evm.chainRules.IsAdventure:
		evm.table = &adventureInstructionSet
	// ##
