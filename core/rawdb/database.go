...
func (frdb *freezerdb) SetupFreezerEnv(env *ethdb.FreezerEnv) error {
	return frdb.chainFreezer.SetupFreezerEnv(env)
}
...
func InspectDatabase(db ethdb.Database, keyPrefix, keyStart []byte) error {
	...
	stats := [][]string{
		...
		{"Key-Value store", "Difficulties", tds.sizeString(), tds.countString()},                   // ##CROSS: legacy sync
		{"Key-Value store", "BlobSidecars", blobSidecars.sizeString(), blobSidecars.countString()}, // ##CROSS: blob sidecars
		...
		{"Key-Value store", "Istanbul snapshots", istanbulSnaps.sizeString(), istanbulSnaps.countString()}, // ##CROSS: istanbul
