...
// ##CROSS: istanbul
// IstanbulHashWithRoundNumber gets the hash of the Header with Only commit seal set to its null value
func (h *Header) IstanbulHashWithRoundNumber(round uint32) common.Hash {
	return rlpHash(IstanbulFilteredHeaderWithRound(h, round))
}
