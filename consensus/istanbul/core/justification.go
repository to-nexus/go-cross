...
// prepared block.
func hasQuorumOfRoundChangeMessagesForNil(roundChangeMessages []*protocols.SignedRoundChangePayload, quorumSize int) error {
	nilCount := 0
...
func hasQuorumOfRoundChangeMessagesForPreparedRoundAndBlock(roundChangeMessages []*protocols.SignedRoundChangePayload, preparedRound *big.Int, preparedBlock istanbul.Proposal, quorumSize int) error {
